...
Interfaz de inventario y administración

Backend

Node.js + Express

API REST, validación y autorización

Base de datos

MariaDB

Persistencia de segmentos, IP, usuarios y auditoría

Proxy web

Nginx

Publicación del frontend y proxy de /api

Servicio

systemd

Inicio y reinicio automático del backend
...
Crear, editar o eliminar IP

Sí

No

Crear, editar o eliminar segmentos
...
IP o dominio de acceso. Detecta automáticamente la IPv4 principal.

Nombre del administrador.

Nombre de usuario del administrador.

Contraseña inicial de al menos 10 caracteres.
...
Directorio donde se ejecutó git clone
...
/var/www/inventario-ips

Unidad systemd

/etc/systemd/system/inventario-ips.service

Configuración Nginx

/etc/nginx/sites-available/inventario-ips

Enlace Nginx

/etc/nginx/sites-enabled/inventario-ips

Log de acceso Nginx

/var/log/nginx/inventario-ips-access.log

Log de error Nginx

/var/log/nginx/inventario-ips-error.log
...
Redes, prefijos, gateway, VLAN y ubicación

direcciones_ip

IP, equipo, responsable, estado y segmento

usuarios

Cuenta, hash de contraseña, rol y estado

auditoria

Inicio de sesión y operaciones realizadas
